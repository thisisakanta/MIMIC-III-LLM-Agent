...
from utils_helper import extract_features, get_feature_names
...
def get_feature_names_from_header(header, period, features):
    """
    Get feature names based on header, period, and features.
    
    Args:
        header: List of channel names
    ...
    """
    return get_feature_names(header, period, features)
